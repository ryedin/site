...
Getting started with Sinatra on Convox is easy. Your app will need a `Dockerfile` and `docker-compose.yml` which you can either provide or generate using `convox init`.
