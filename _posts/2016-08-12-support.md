...
**Convox** uses a [reference VPC architecture](https://convox.com/docs/rack/) that is [open-source](https://github.com/convox/rack), fully-automated, used by hundreds of other companies and is [certified by AWS](https://aws.amazon.com/containers/partners/).
...
**Convox Apps** use a simple CloudFormation → ELB → ECS → CloudWatch Logs architecture.

If you aren’t seeing impeccable uptime at industry-best costs, let us know and we’ll help root cause the problems.

Every time you run **`convox rack update`** you’ll benefit from the new performance, reliability and cost-savings improvements we found.

When we’re all building on a common framework, not building frankenstein systems, **AWS, Convox and the Convox Community** are all here to help you be successful.
...
For customers with the biggest demands we’ll even join your Slack or invite you to ours. In this way Convox feels exactly like the DevOps team you want to hire. Ask us a question and we’ll get you a response ASAP. You can go back to building your business.
