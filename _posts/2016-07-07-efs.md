---
title: "AWS EFS — The Cloud Filesystem We’ve Been Waiting For?"
author: Noah Zoschke
twitter: nzoschke
---
...
We’ll see that EFS is quite easy to get up and running, and that it works as advertised. A Postgres data directory is synchronized to every instance in the cluster. This allows us to run, kill and reschedule a Postgres container anywhere in the cluster and resume serving the persistent data.
